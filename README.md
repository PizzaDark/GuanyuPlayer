...
**安卓版：**[PizzaDark/GuanyuPlayer-android (github.com)](https://github.com/PizzaDark/GuanyuPlayer-android)
...
## 文件说明
  ...
  guanyu_song_1~4.mp3        - 抽卡模式音频文件（可选）
...
## 音乐设置
  ...
  **预设模式：**
  - 预设1：经典模式 - 使用 guanyu_song.mp3（单曲）
  - 预设2：抽卡模式 - 使用 guanyu_song_1.mp3 ~ guanyu_song_4.mp3（随机4选1）
...
## 常见问题
  ...
  Q: v1.0和v2.0有什么区别？
  A: v2.0支持多关键词、多音乐文件、自定义模型路径等新功能，详见上方"v2.0新特性"章节
